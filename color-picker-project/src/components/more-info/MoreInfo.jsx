    ...
    return (
        <section className="more-info-section">
            ...
            <div className="info-container">
                ...
                <p>First, you'll need a starting color. This will be the color that PalettePro bases its recommendation on. You can use the color wheel to select a color, or if you know the exact color code that you're looking for (in hex, rgb, hsl, or hsv format) you can simply input that into the appropriate field to select your color. </p>

                <p>Next, we'll need a little more information about how you'll be using the selected color. You can provide that information on the Color Details form. The only required field is the first question on the form: what are you using your selected color for? Select a specific use case from the dropdown menu; if your use case is not on the list, select "other." You'll have the opportunity to provide more information later!</p>

                <p>If there's a specific mood or emotion that you're trying to evoke with your project, you can add that into the form. This will be factored into the recommendation to help you get the best result possible, but you can leave this field blank if you'd like.</p>
